				...
				<div class="container">
					<nav class="navbar navbar-expand">
						...
						<ul class="navbar-nav ms-auto d-none d-lg-flex">
							<li class="nav-item"> <a class="nav-link text-gray" href="{{route('order-tracking')}}">Track Order</a>
							</li>
							<li class="nav-item"> <a class="nav-link text-gray" href="{{route('shop-categories')}}">Instant Quote</a>
							</li>
							...
							<li class="nav-item"> <a class="nav-link text-gray" href="{{route('shop-categories')}}">FAQ</a>
							</li>
							<li class="nav-item"> <a class="nav-link text-gray" href="{{route('contact-us')}}">Help & Support</a>
							</li>
						</ul>
						<ul class="navbar-nav">
						...
						<div class="col col-md-auto">
							<div class="d-flex align-items-center">
								...
								<div class="logo d-none d-lg-flex">
									<a href="{{route('home')}}">
										<img src="{{ URL::asset('assets/images/NuvemPrint.png')}}" class="logo-icon" alt="" />
    ...
    <div class="dropdown-menu dropdown-large-menu custom-mega-menu">
        <div class="row">
            ...
            <div class="col-md-5 custom-subcat-list">
                @foreach($menucats as $index => $menucat)
                    <div class="custom-subcat-content {{ $index == 0 ? 'd-block' : 'd-none' }}" id="cat-{{ $menucat->id }}">
            ...
            <div class="col-md-3">
                <div class="pramotion-banner1">
                    <img src="{{ URL::asset('assets/images/gallery/menu-img.jpg')}}" class="img-fluid"
