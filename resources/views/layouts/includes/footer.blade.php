						...
						<div class="col">
							<div class="footer-section2 mb-3">
								...
								<ul class="list-unstyled">
									...
									<li class="mb-1"><a href="{{ route('subcategory-details', ['slug' => $fsubcate->slug]) }}"><i class='bx bx-chevron-right'></i>{{$fsubcate->name}}</a></li>
									@endforeach
									@endif
							...
							<div class="col-12 col-lg-6">
								<div class="image-zoom-section">
									<div class="product-gallery owl-carousel owl-theme border mb-3 p-3"
										data-slider-id="1">
										<div class="item">
											<img src="{{ URL::asset('assets/images/product-gallery/01.png') }}" class="img-fluid" alt="">
										</div>
										<div class="item">
											<img src="{{ URL::asset('assets/images/product-gallery/02.png') }}" class="img-fluid" alt="">
										</div>
										<div class="item">
											<img src="{{ URL::asset('assets/images/product-gallery/03.png') }}" class="img-fluid" alt="">
										</div>
										<div class="item">
											<img src="{{ URL::asset('assets/images/product-gallery/04.png') }}" class="img-fluid" alt="">
										</div>
									</div>
