                             ...
                             <div class="form-row d-flex align-items-end" style="display: flex;">
                               ...
                               <div class="form-group col-md-2">
                                    ...
                                    <select class="form-control" name="proof_reading_required" id="proof_reading_required" required>
                                        ...
                                        <option value="1" {{ $pricingRule->proof_reading_required ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ !$pricingRule->proof_reading_required ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <option value="">-- Select --</option>
                                    <option value="1" {{ $pricingRule->delivery_charges_required ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ !$pricingRule->delivery_charges_required ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-2" id="pages_dragger_required-wrapper" >
                                    ...
                                    <option value="">-- Select --</option>
                                    <option value="1" {{ $pricingRule->pages_dragger_required ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ !$pricingRule->pages_dragger_required ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>

                                <div class="form-group col-md-2" id="pages-dragger-dependency-group"
                                    style="{{ $pricingRule->pages_dragger_required ? '' : 'display:none;' }}">
                                  ...
                                  <div class="form-group col-md-2" id="default-pages-group"  style="{{ $pricingRule->pages_dragger_required ? '' : 'display:none;' }}">
