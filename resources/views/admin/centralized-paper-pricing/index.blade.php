          ...
          <div class="card-body">
            ...
            <div class="tab-content" id="pricingTabContent">
              ...
              <div class="tab-pane fade" id="cover-paper-weight-rates" role="tabpanel">
                <div class="mb-2 text-right">
                  @if($coverPaperWeightPricing->isEmpty())
                    <a href="{{ route('admin.cover-paper-weight-rates.create') }}" class="btn btn-primary btn-sm">
                      ＋ Add Cover Paper Weight Rate
                    </a>
                  @else
                    <a href="{{ route('admin.cover-paper-weight-rates.edit', $coverPaperWeight->id) }}" class="btn btn-primary btn-sm">
                ...
                @else
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        @foreach($coverPaperWeightPricing as $rule)
                          <tr>
                            <td>{{ $rule['attribute']['name'] ?? '-' }}</td>
                            <td>{{ $rule['value']['value'] ?? '-' }}</td>
                            <td>
