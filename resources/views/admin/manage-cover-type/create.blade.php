  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form id="cover-type-form" enctype="multipart/form-data">
        ...
        <button type="button" class="btn btn-outline-primary btn-sm mt-2" id="add-more-cover-type">
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-primary" id="add-cover-type-btn">Create</button>
    </div>
  </div>
</div>