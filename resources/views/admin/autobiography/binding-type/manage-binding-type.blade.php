              ...
              <div class="table-responsive">
                <table class="table" id="pagetype-table">
                  ...
                  <tbody>
					  ...
					  <td>{{ $binding_type->has_custom_cover }}</td>
...
<script type="text/javascript">
  ...
  function deleteConfirmation(id){
      Swal.fire({
          ...
          if (result.isConfirmed) {
              $.ajax({
                  url:`{{ URL::to('admin/manage-bio-binding-type/${id}') }}`,
                  type:"DELETE",
                  dataType:"json",
  ...
  $(document).ready( function () {
    ...
    $(document).on('click','#add-binding-type',function(event){
        $.ajax({
            url:"{{ URL::to('admin/manage-bio-binding-type/create') }}",
            type:"GET",
            dataType:"json",
            success:function(result) {
                if (result.success) {
    ...
    $(document).on("click","#add-binding-type-btn",function(event){
		...
		formData.append('has_custom_cover',$('#has_custom_cover').val());
        formData.append('price',$('#price').val());
        formData.append('status',$('#status').val());
        $.ajax({
            url:"{{ URL::to('admin/manage-bio-binding-type') }}",
            type:'POST',
            processData: false,
            contentType: false,
            dataType:'json',
    ...
    $(document).on("click",".edit-binding-type",function(event){
      ...
      $.ajax({
          url:`{{ URL::to('admin/manage-bio-binding-type/${id}/edit') }}`,
          type:"get",
          dataType:"json",
          success:function(result) {
            if(result.success) {
