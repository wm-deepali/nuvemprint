...
<script type="text/javascript">
  ...
  function deleteConfirmation(id){
      Swal.fire({
          ...
          if (result.isConfirmed) {
              $.ajax({
                  url:`{{ URL::to('admin/manage-bio-paper-grade/${id}') }}`,
                  type:"DELETE",
                  dataType:"json",
  ...
  $(document).ready( function () {
    ...
    $(document).on('click','#add-paper-grade',function(event){
        $.ajax({
            url:"{{ URL::to('admin/manage-bio-paper-grade/create') }}",
            type:"GET",
            dataType:"json",
            success:function(result) {
                if (result.success) {
    ...
    $(document).on("click","#add-paper-grade-btn",function(event){
        ...
        $.ajax({
            url:"{{ URL::to('admin/manage-bio-paper-grade') }}",
            type:'POST',
            processData: false,
            contentType: false,
            dataType:'json',
    ...
    $(document).on("click",".edit-paper-grade",function(event){
      ...
      $.ajax({
          url:`{{ URL::to('admin/manage-bio-paper-grade/${id}/edit') }}`,
          type:"get",
          dataType:"json",
          success:function(result) {
            if(result.success) {
