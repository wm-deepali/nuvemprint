...
<script type="text/javascript">
  ...
  function deleteConfirmation(id){
      Swal.fire({
          ...
          if (result.isConfirmed) {
              $.ajax({
                  url:`{{ URL::to('admin/manage-bio-university-country/${id}') }}`,
                  type:"DELETE",
                  dataType:"json",
  ...
  $(document).ready( function () {
    ...
    $(document).on('click','#add-university-country',function(event){
        $.ajax({
            url:"{{ URL::to('admin/manage-bio-university-country/create') }}",
            type:"GET",
            dataType:"json",
            success:function(result) {
                if (result.success) {
    ...
    $(document).on("click","#add-university-country-btn",function(event){
        ...
        $.ajax({
            url:"{{ URL::to('admin/manage-bio-university-country') }}",
            type:'POST',
            processData: false,
            contentType: false,
            dataType:'json',
    ...
    $(document).on("click",".edit-university-country",function(event){
      ...
      $.ajax({
          url:`{{ URL::to('admin/manage-bio-university-country/${id}/edit') }}`,
          type:"get",
          dataType:"json",
          success:function(result) {
            if(result.success) {
