<div class="modal-dialog modal-dialog-centered modal-lg">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title mb-0">Add Cover Finish</h5>
    ...
    <div class="modal-body">
      <form id="cover-finish-form" enctype="multipart/form-data">
        ...
        <button type="button" class="btn btn-outline-primary btn-sm mt-2" id="add-more-cover-finish">
    ...
    <div class="modal-footer justify-content-between">
      ...
      <button type="button" class="btn btn-primary" id="add-cover-finish-btn">
