        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Approval Proofs List</h4>
            </div>
            <div class="card-body">
                ...
                <table class="table" id="uploaded-proofs-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $proof->address }}</td>
                      <td>{{ $proof->need_changes }}</td>
                      <td>{{ $proof->postcode }}</td>
                      <td>{{ $proof->receiving_date }}</td>
                      ...
                      <td>
                        ...
                        <form action="{{ route('approval-proofs.destroy', $proof) }}" method="POST" style="display: inline-block">
                            @csrf
                            @method('DELETE')
