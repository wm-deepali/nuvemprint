                            ...
                            <div class="cart-box">
                                ...
                                @if ($cartData)
                                    <div class="d-flex justify-content-between ">
                                        <p style="font-size:1.1rem">Shipping Estimate {{ $formattedDate }}</p>
                                        <h5 style="font-size:1.1rem"><span style="font-weight:500;">Subtotal:</span><span
                                                style="color:#ff4880;"> £{{ $cartData['items']['sub_total'] ?? 0 }} </span></h5>
                                    </div>
                                    <hr style="margin-top:0px;">

                                    <div class="d-flex align-items-start mb-3">
                                        @if($cartData['subcategory_thumbnail'])
                                            <img src="{{ asset('storage/' . $cartData['subcategory_thumbnail']) }}"
                                        ...
                                        @endif
                                        <div class="col-9">
                                            <p class="mb-1"><span style="font-weight:500;">{{ $cartData['items']['quantity'] }}
                                                    {{ $cartData['subcategory_name'] }}</span></p>
                                            @foreach ($cartData['attributes_resolved'] as $attr)
                                                <p class="mb-0" style="font-weight:400;font-size:1rem;color:#212529;">
                                                    ...
                                                    @if (!empty($attr['value_description']))
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p><span style="font-weight:500;">Delivery Weight:</span>
                                            {{ $cartData['paper_total_weight'] }} kg</p>
                                        <div class="d-flex gap-2 mb-4" style=" flex-direction: row-reverse;">

                                            <button class="btn-info trash" data-id="{{ $cartData['quote_id'] ?? '' }}">
                                ...
                                <div class="quote-box">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h5 style="font-size:1.1rem;font-weight:400;">Quote Number:<span
                                                style="font-weight:500;"> #{{ $cartData['quote_id'] ?? '' }}</span></h5>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <span><span style="font-weight:500;">{{ $cartData['subcategory_name'] }} x
                                    ...
                                    <p><span style="font-weight:500;">Total Weight:</span> {{ $cartData['paper_total_weight'] }}
                                        kg</p>
                                    ...
                                    <div class="mb42">
                                        ...
                                        <select class="form-select custom-op" id="deliverySelect" name="delivery[id]">
                                            @foreach($allDeliveryCharges->groupBy('continent') as $continent => $charges)
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span id="subtotal"
                                            style="font-weight:500;">£{{ $cartData['items']['sub_total'] ?? 0}}</span>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between  mt-2">
                                        ...
                                        <span><span style="font-weight:500;"
                                                id="grandTotalAmount">£{{ $cartData['grand_total'] }}</span></span>
                                    </div>
                                    <hr>
