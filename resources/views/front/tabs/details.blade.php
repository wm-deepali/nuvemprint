<div id="loginPrompt" style="display: none; max-width: 100%; margin: 15px auto; padding: 12px 16px; text-align: center; background: #f1f1f1; border: 1px solid #ccc; border-radius: 6px; font-family: 'Segoe UI', sans-serif;">
    <p style="margin: 0; font-size: 14px; color: #444;">
        Please <a href="{{ route('authentication-signin') }}" style="color: #007bff; font-weight: 500; text-decoration: none;">sign in</a>
        or <a href="{{ route('authentication-signup') }}" style="color: #007bff; font-weight: 500; text-decoration: none;">create an account</a> to continue.
    </p>
</div>
    ...
    <div>
        <div class="custom-art-tab-section-left">
         ...
         <div class="custom-art-card">
            ...
            $paperTypeValue = collect($attributes_resolved)->firstWhere('attribute_name', 'Paper Type')['value_name'] ?? ''; @endphp
            <div class="custom-art-field custom-art-gsm-options">
               <label>{{ $paperWeightValue }}<span class="custom-art-subtext">paper - {{ $paperTypeValue }}</span></label>
