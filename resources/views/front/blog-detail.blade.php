                                ...
                                <div class="card shadow-none bg-transparent">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="list-inline mt-4"> <a href="javascript:;" class="list-inline-item"><i
                                            ...
                                            <a href="javascript:;" class="list-inline-item"><i
                                                    class='bx bx-calendar me-1'></i>{{ $blog->created_at->format('F d, Y') }}</a>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 py-4 border-top border-bottom">
                                            ...
                                            <div class="list-inline blog-sharing">
                                                ...
                                                <a href="https://www.tumblr.com/widgets/share/tool?canonicalUrl={{ $shareUrl }}&title={{ $shareText }}"
                                                    target="_blank" class="list-inline-item">
                                        ...
                                        @foreach ($recentBlogs as $recent)
                                            <div class="item">
                                                <div class="card rounded-0 product-card border">
                                                    <div class="news-date">
                                                        <div class="date-number">{{ $recent->created_at->format('d') }}</div>
                                                        <div class="date-month">
                                                            {{ strtoupper($recent->created_at->format('M')) }}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="news-content mb-0">
                                                            {{ \Illuminate\Support\Str::limit(strip_tags($recent->detail), 100) }}
                                                        </p>
                                                    </div>
