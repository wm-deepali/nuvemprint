											...
											<div class="card rounded-0 custom-card">
												<div class="row g-0 align-items-stretch h-100">
													<div class="col-6 custom-image-box">
														<img src="{{ asset('storage/' . $indexsubcate->thumbnail) }}"
													...
													<div class="col-6 d-flex align-items-center">
														<div class="card-body">
															...
															<a href="{{ route('subcategory-details', ['slug' => $indexsubcate->slug]) }}"
								...
								@foreach($blogs as $blog)
									<div class="item">
										<div class="card rounded-0 product-card border">
											<div class="news-date">
												<div class="date-number">{{ \Carbon\Carbon::parse($blog->created_at)->format('d') }}
												</div>
												<div class="date-month">{{ \Carbon\Carbon::parse($blog->created_at)->format('M') }}
												</div>
											</div>
											<a href="{{ route('blogs.show', $blog->slug) }}">
												<img src="{{ asset('storage/' . $blog->thumbnail) }}"
													class="card-img-top border-bottom bg-dark-1" alt="{{ $blog->title }}"
													height="200px">
											</a>
											<div class="card-body">
												<div class="news-title">
													<a href="{{ route('blogs.show', $blog->slug) }}">
														<h5 class="mb-3 text-capitalize">{{ Str::limit($blog->title, 50) }}</h5>
													</a>
												</div>
												<p class="news-content mb-0">{{ Str::limit(strip_tags($blog->detail), 100) }}</p>
											</div>
