...
<!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				@if(isset($indexsubcates) && count($indexsubcates)>0)
								    
				<section class="py-4">
					<div class="container">
						<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
						    @foreach($indexsubcates as $indexsubcate)
							<div class="col">
  ...
  <div class="card rounded-0 custom-card">
    <div class="row g-0 align-items-stretch h-100">
      <div class="col-6 custom-image-box">
        <img src="{{ asset('storage/'.$indexsubcate->thumbnail) }}" class="custom-image" alt="" />
      </div>
      <div class="col-6 d-flex align-items-center">
        <div class="card-body">
          <h5 class="card-title text-uppercase" style="font-size:16px;">{{ $indexsubcate->name }}</h5>
          <p class="card-text text-uppercase">Starting at $9</p>
          <a href="{{ route('subcategory-details', ['slug' => $indexsubcate->slug]) }}" class="btn btn-light btn-ecomm">Order Now</a>
        </div>
      </div>
    </div>
  </div>
								...
								<div class="item">
									<div class="card rounded-0 product-card border" style="background-color: rgb(0 0 0 / 20%);">
										...
										<div class="card-footer text-center" style="height:60px;">
											<h6 class="mb-1 text-uppercase text-gray">{{$category->name}}</h6>
							...
							<div class="latest-news owl-carousel owl-theme">
								<div class="item">
									<div class="card rounded-0 product-card border">
										...
										<a href="javascript:;">
											<img src="{{ URL::asset('assets/images/duplo.jpeg')}}"
								...
								<div class="item">
									<div class="card rounded-0 product-card border">
										...
										<a href="javascript:;">
											<img src="{{ URL::asset('assets/images/thesis.jpeg')}}"
												class="card-img-top border-bottom bg-dark-1" alt="..." height="200px">
										</a>
										<div class="card-body">
											<div class="news-title">
								...
								<div class="item">
									<div class="card rounded-0 product-card border">
										...
										<a href="javascript:;">
											<img src="{{ URL::asset('assets/images/banner.jpeg')}}"
												class="card-img-top border-bottom bg-dark-1" alt="..." height="200px">
										</a>
										<div class="card-body">
											<div class="news-title">
								...
								<div class="item">
									<div class="card rounded-0 product-card border">
										...
										<a href="javascript:;">
											<img src="{{ URL::asset('assets/images/blogs/04.png')}}"
												class="card-img-top border-bottom bg-dark-1" alt="..." height="200px">
										</a>
										<div class="card-body">
											<div class="news-title">
