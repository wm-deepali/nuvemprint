							...
							<div class="card mb-0">
								<div class="card-body">
									<div class="border p-4 rounded">
										...
										<div class="form-body">
											<form class="row g-3" id="registerForm" method="post" action="{{ route('reset.password.post') }}" enctype="multipart/form-data">
											@csrf
												...
												<div class="col-12">
													<div class="d-grid">
														<button type="submit" class="btn btn-light"><i class='bx bx-user'></i>Submit</button>
													</div>
												</div>
											</form>
										</div>
