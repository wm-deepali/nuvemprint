        ...
        <div class="form-row pt-1">
          ...
          <div class="form-group col-md-4">
            ...
            <select name="is_premium" id="is_premium" class="form-control">
              <option value="no" <?php echo e($subcategory->is_premium == 'no' ? 'selected' : ''); ?>>No</option>
              <option value="yes" <?php echo e($subcategory->is_premium == 'yes' ? 'selected' : ''); ?>>Yes</option>
            </select>
...
</div><?php /**PATH D:\web-mingo-project\nuvem_prints\resources\views/admin/subcategories/ajax/edit-subcategory.blade.php ENDPATH**/ ?>