        ...
        <div class="card">
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="pricingTab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="sra3-counts-tab" data-toggle="tab" href="#cover-paper-weight-rates"
                  role="tab">Cover
                  Paper Weight Rates</a>
              </li>
            </ul>
            ...
            <div class="tab-content" id="pricingTabContent">
              ...
              <div class="tab-pane fade" id="cover-paper-weight-rates" role="tabpanel">
                <div class="mb-2 text-right">
                  <?php if($coverPaperWeightPricing->isEmpty()): ?>
                    <a href="<?php echo e(route('admin.cover-paper-weight-rates.create')); ?>" class="btn btn-primary btn-sm">
                      ＋ Add Cover Paper Weight Rate
                    </a>
                  <?php else: ?>
                    <a href="<?php echo e(route('admin.cover-paper-weight-rates.edit', $coverPaperWeight->id)); ?>" class="btn btn-primary btn-sm">
                      Edit Cover Paper Weight Rates
                    </a>
                  <?php endif; ?>
                </div>

                <?php if($coverPaperWeightPricing->isEmpty()): ?>
                  <p>No pricing data for cover paper weight.</p>
                <?php else: ?>
                    ...
                    <table class="table table-bordered table-striped">
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th>Value</th>
                          <th>Dependencies</th>
                          <th>Price (SRA3 sheet)</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php $__currentLoopData = $coverPaperWeightPricing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td><?php echo e($rule['attribute']['name'] ?? '-'); ?></td>
                            <td><?php echo e($rule['value']['value'] ?? '-'); ?></td>
                            <td>
