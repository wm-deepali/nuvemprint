          ...
          <div class="delivery-block border p-2 mb-2">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" name="delivery_charges[0][delivery]" class="form-control" placeholder="Enter title">
                <span class="text-danger validation-err" id="delivery_charges_0_delivery-err"></span>
              </div>
            </div>
