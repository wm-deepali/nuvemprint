      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div id="attribute-items-wrapper">
          <div class="attribute-item border rounded p-1 mb-1 bg-light">
            ...
            <option value="<?php echo e($attribute->id); ?>" data-input-type="<?php echo e($attribute->input_type); ?>"><?php echo e($attribute->name); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
...
<?php /**PATH D:\web-mingo-project\nuvem_prints\resources\views/admin/subcategory-attributes/create.blade.php ENDPATH**/ ?>