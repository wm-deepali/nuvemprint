						...
						<ul class="list-unstyled">
							...
							<?php if(isset($fsubcates) && count($fsubcates) > 0): ?>
								<?php $__currentLoopData = $fsubcates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fsubcate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<li class="mb-1"><a
											href="<?php echo e(route('subcategory-details', ['slug' => $fsubcate->slug])); ?>"><i
					...
					<div class="col-12 col-lg-6">
						<div class="image-zoom-section">
							<div class="product-gallery owl-carousel owl-theme border mb-3 p-3" data-slider-id="1">
								<div class="item">
									<img src="<?php echo e(URL::asset('assets/images/product-gallery/01.png')); ?>"
										class="img-fluid" alt="">
								</div>
								<div class="item">
									<img src="<?php echo e(URL::asset('assets/images/product-gallery/02.png')); ?>"
										class="img-fluid" alt="">
								</div>
								<div class="item">
									<img src="<?php echo e(URL::asset('assets/images/product-gallery/03.png')); ?>"
										class="img-fluid" alt="">
								</div>
								<div class="item">
									<img src="<?php echo e(URL::asset('assets/images/product-gallery/04.png')); ?>"
										class="img-fluid" alt="">
								</div>
							</div>
