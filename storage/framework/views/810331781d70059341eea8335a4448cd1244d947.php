    ...
    <div class="content-body">
      ...
      <div class="col-md-12">
        ...
        <?php endif; ?>
          ...
          onclick="editDepartment(<?php echo e($department->id); ?>, '<?php echo e($department->name); ?>', '<?php echo e($department->status); ?>')">Edit</button>

          <button class="btn btn-sm btn-danger"
          onclick="deleteConfirmation(<?php echo e($department->id); ?>)">Delete</button>
...
<?php $__env->startPush('scripts'); ?>
  <script>
    ...
    $('#addDepartmentForm').on('submit', function (e) {
      ...
      let url = '<?php echo e(route('admin.manage-department.store')); ?>';
      let method = 'POST';
