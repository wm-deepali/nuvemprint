...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('admin_assets')); ?>/images/favicon.png">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin_assets')); ?>/css/flatpickr.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin_assets')); ?>/css/bootstrap.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin_assets')); ?>/css/bootstrap-extended.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin_assets')); ?>/css/chart-apex.min.css">
...
<body class="horizontal-layout horizontal-menu blank-page navbar-floating footer-static" data-open="hover" data-menu="horizontal-menu" data-col="blank-page">
      ...
      <div class="content-body">
        <div class="auth-wrapper auth-v1 px-2">
          <div class="auth-inner py-2">
            <div class="card mb-0">
              <div class="card-body">
                <a href="javascript:void(0);" class="brand-logo"><img src="<?php echo e(asset('admin_assets')); ?>/images/logo.png" width="150" alt=""></a>
  ...
  <script src="<?php echo e(asset('admin_assets')); ?>/js/jquery.sticky.js"></script>
  <script src="<?php echo e(asset('admin_assets')); ?>/js/bs-stepper.min.js"></script>
  <script src="<?php echo e(asset('admin_assets')); ?>/js/select2.full.min.js"></script>
  <script src="<?php echo e(asset('admin_assets')); ?>/js/apexcharts.min.js"></script>
  <script src="<?php echo e(asset('admin_assets')); ?>/js/flatpickr.min.js"></script>
  <script src="<?php echo e(asset('admin_assets')); ?>/js/app-menu.min.js"></script>
  <script src="<?php echo e(asset('admin_assets')); ?>/js/app.min.js"></script>
  <script src="<?php echo e(asset('admin_assets')); ?>/js/chart-apex.min.js"></script>
  <script src="<?php echo e(asset('admin_assets')); ?>/js/form-select2.min.js"></script>
...
<?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/auth/login.blade.php ENDPATH**/ ?>