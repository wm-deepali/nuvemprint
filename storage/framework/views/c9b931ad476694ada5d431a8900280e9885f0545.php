      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <select name="action" class="form-control">
            <option value="show" <?php echo e($condition->action == 'show' ? 'selected' : ''); ?>>Show</option>
            <option value="hide" <?php echo e($condition->action == 'hide' ? 'selected' : ''); ?>>Hide</option>
            <option value="change_options" <?php echo e($condition->action == 'change_options' ? 'selected' : ''); ?>>Change Options</option>
          </select>
...
<?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/admin/attribute-conditions/edit.blade.php ENDPATH**/ ?>