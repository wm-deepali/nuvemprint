            ...
            <div class="modal-body">
                    ...
                    <div class="vat-block border p-2 mb-2">
                        <div class="form-group">
                            ...
                            <select name="country" class="form-control" required>
                                ...
                                <option value="United Kingdom" <?php echo e($Vat->country == 'United Kingdom' ? 'selected' : ''); ?>>
                                    United Kingdom</option>
                                <option value="Ireland" <?php echo e($Vat->country == 'Ireland' ? 'selected' : ''); ?>>Ireland
                                </option>
                                <option value="Europe" <?php echo e($Vat->country == 'Europe' ? 'selected' : ''); ?>>Europe</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="vat_percentage" class="form-control" step="1"
                                value="<?php echo e($Vat->vat_percentage); ?>" placeholder="Enter Percentage">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="update-manage-vat-btn" class="btn btn-primary"
                        data-id="<?php echo e($Vat->id); ?>">Update</button>
                </div>

        </form>
    </div>
</div><?php /**PATH D:\web-mingo-project\new\resources\views/admin/manage-vat/edit.blade.php ENDPATH**/ ?>