          ...
          <div class="delivery-block border p-2 mb-2">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <select name="delivery_charges[0][title]" class="form-control" required>
    ...
    $('#add-more-delivery').off('click').on('click', function () {
      ...
      <div class="delivery-block border p-2 mb-2">
        <div class="row">
          ...
          <div class="form-group col-md-4">
              <label>Delivery Country<span class="text-danger">*</span></label>
              <select name="delivery_charges[${valueIndex}][title]" class="form-control" required>
                <option value="">-- Select Country --</option>
                <option value="United Kingdom">United Kingdom</option>
                <option value="Ireland">Ireland</option>
                <option value="Europe">Europe</option>
              </select>
              <span class="text-danger validation-err" id="delivery_charges_${valueIndex}_title-err"></span>
            </div>
        </div>
