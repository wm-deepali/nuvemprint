            ...
            <div class="modal-body">
                <div>
                    <div class="form-group">
                        ...
                        <select name="is_serviceable" class="form-control">
                            <option value="1" <?php echo e($PostalCode->is_serviceable ? 'selected' : ''); ?>>Yes</option>
                            <option value="0" <?php echo e(!$PostalCode->is_serviceable ? 'selected' : ''); ?>>No</option>
                        </select>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="update-postal-code-btn" class="btn btn-primary"
                        data-id="<?php echo e($PostalCode->id); ?>">Update</button>
                </div>

        </form>
    </div>
</div><?php /**PATH D:\web-mingo-project\new\resources\views/admin/postal-code/edit.blade.php ENDPATH**/ ?>