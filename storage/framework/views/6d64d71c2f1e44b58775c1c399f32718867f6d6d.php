  ...
  <div class="modal-content">
    <form id="subcategory-attribute-form">
      ...
      <div class="modal-body">
        ...
        <option value="<?php echo e($subcategory->id); ?>" <?php echo e($subcategoryAttribute->subcategory_id == $subcategory->id ? 'selected' : ''); ?>>
      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <option value="<?php echo e($attribute->id); ?>" <?php echo e($subcategoryAttribute->attribute_id == $attribute->id ? 'selected' : ''); ?>>
      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="form-group">
          ...
          <select name="is_required" class="form-control">
            <option value="1" <?php echo e($subcategoryAttribute->is_required ? 'selected' : ''); ?>>Yes</option>
            <option value="0" <?php echo e(!$subcategoryAttribute->is_required ? 'selected' : ''); ?>>No</option>
          </select>
        </div>

        <div class="form-group">
          <label>Sort Order</label>
          <input type="number" name="sort_order" class="form-control" value="<?php echo e($subcategoryAttribute->sort_order); ?>">
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="save-subcategory-attribute-btn" data-id="<?php echo e($subcategoryAttribute->id); ?>"
...
</script><?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/admin/subcategory-attributes/edit.blade.php ENDPATH**/ ?>