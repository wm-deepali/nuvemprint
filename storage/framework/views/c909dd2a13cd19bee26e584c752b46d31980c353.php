    ...
    <form id="proof-reading-form" enctype="multipart/form-data">
      ...
      <div class="modal-body">
        <div>
          <div class="reading-block border p-2 mb-2">
            <div class="form-group" id="reading-input-wrapper-0">
              ...
              <input type="text"  value="<?php echo e($ProofReading->proof_type); ?>" name="proof_type" class="form-control">
              <span class="validation-err proof_type-err text-danger"></span>
            </div>

            <div class="form-group" id="title-wrapper-0">
              <label>Price <span class="text-danger">*</span></label>
              <input type="text" name="price" class="form-control"  value="<?php echo e($ProofReading->price); ?>" >
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="update-proof-reading-btn" class="btn btn-primary"   data-id="<?php echo e($ProofReading->id); ?>">Update</button>
        </div>

    </form>
  </div>
</div>
<?php /**PATH D:\web-mingo-project\new\resources\views/admin/proof-reading/edit.blade.php ENDPATH**/ ?>