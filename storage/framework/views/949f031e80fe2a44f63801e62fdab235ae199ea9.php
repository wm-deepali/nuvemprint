   ...
   function renderSingleFilePreview(file) {
      ...
      removeBtn.onclick = () => {
         ...
         fetch("/cart/remove-file", {
            ...
            body: JSON.stringify({
               type: "main",
               path: '<?php echo e(optional(session("cart.images")) ? collect(session("cart.images"))->where("type", "main")->first()["path"] ?? "" : ""); ?>', // if you have the path
            }),
         });
      };
...
<?php /**PATH D:\web-mingo-project\nuvem_prints\resources\views/front/tabs/artwork.blade.php ENDPATH**/ ?>