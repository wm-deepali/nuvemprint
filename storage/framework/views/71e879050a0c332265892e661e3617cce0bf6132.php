                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo e(route('admin.quote.index')); ?>" class="btn btn-sm btn-info mb-1">View Quote Detail</a>
                          <a href="<?php echo e(route('admin.customers.detail')); ?>" class="btn btn-sm btn-primary mb-1">View Customer Detail</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/admin/customer_estimates/quote_request.blade.php ENDPATH**/ ?>