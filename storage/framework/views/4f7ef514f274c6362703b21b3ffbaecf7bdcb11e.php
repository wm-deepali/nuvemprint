                            			...
                            			<div class="card shadow-lg border-0">
                            				<div class="d-flex align-items-start mb-4 p-4">
                                				<div class="position-relative">
                                					...
                                					<?php if(strpos($user->profile_pic,'https') !== false): ?> 
                                					<img src="<?php echo e($user->profile_pic); ?>" class="rounded-circle" width="100" height="100" alt="Profile Image">
                                                    <?php else: ?>
                                                    <img src="<?php echo e(asset('storage').'/'.$user->profile_pic); ?>" class="rounded-circle" width="100" height="100" alt="Profile Image">
                                                    <?php endif; ?>
                                                    <?php else: ?>
                                				...
                                				<div class="ms-3">
                                					...
                                					<p class="mb-1"><strong>Phone:</strong> <?php echo e($user->mobile ?? ""); ?></p>
                            				...
                            				<div class="card-body">
                            					...
                            					<form class="row g-3" id="profileForm">
                            						...
                            						<div class="col-md-6">
                            							...
                            							<input type="text" name="mobile" id="mobile" class="form-control" value="<?php echo e($user->mobile ?? ""); ?>" required>
                            							<div class="invalid-feedback" id="error-mobile"></div>
                            						</div>
                            						<div class="col-md-6">
                            							<label class="form-label">Whatsapp</label>
                            							<input type="text" name="whatsapp_number" id="whatsapp_number" class="form-control" value="<?php echo e($user->whatsapp_number ?? ""); ?>" required>
                            							<div class="invalid-feedback" id="error-whatsapp_number"></div>
                            						</div>
                            						<div class="col-12">
                            							<label class="form-label">Display Name</label>
                            							<input type="text" name="display_name" id="display_name" class="form-control" value="<?php echo e($user->first_name . ' ' . $user->last_name); ?>" required>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async function (e) {
        ...
        try {
            const response = await fetch("<?php echo e(route('profile-pic.update')); ?>", {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('input[name="_token"]').value,
                    'Accept': 'application/json',
...
<script>
        $('#change-password-form').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('profile-password.update')); ?>",
                method: "POST",
                data: {
