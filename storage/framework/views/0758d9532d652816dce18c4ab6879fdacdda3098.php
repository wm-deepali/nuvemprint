            ...
            <div class="col-md-6">
                <div class="paper-type-section">
                    <?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" class="btn btn-light text-start <?php echo e($value['is_default'] ? 'active' : ''); ?>"
...
<?php elseif($inputType === 'radio'): ?>
    <div class="<?php echo e(in_array($attribute['name'], ['Paper Weight', 'Cover Paper Weight']) ? 'col-md-12 attribute-wrapper' : 'col-md-6 attribute-wrapper'); ?> mb-3"
        ...
        <div class="attribute-values <?php echo e(count($values) <= 4 ? 'color-print' : 'color-print1'); ?>">
            <?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="print-color <?php echo e($value['is_default'] ? 'active' : ''); ?>"
                    data-price="<?php echo e($value['price']); ?>"
                    data-attribute-id="<?php echo e($attribute['id']); ?>"
                    data-value-id="<?php echo e($value['id']); ?>"
                    data-modifier="<?php echo e($value['price_modifier_type'] ?? 'add'); ?>"
...
<?php elseif($inputType === 'select_image'): ?>
    <div class="attribute-wrapper col-md-12 mb-3" data-attribute-id="<?php echo e($attribute['id']); ?>">
        ...
        <div class="attribute-value color-print1">
            <?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="choose-binding <?php echo e($value['is_default'] ? 'active' : ''); ?>"
                    data-value="<?php echo e($value['value']); ?>"
                    data-price="<?php echo e($value['price']); ?>"
                    data-attribute-id="<?php echo e($attribute['id']); ?>"
                    data-value-id="<?php echo e($value['id']); ?>"
        ...
        <select class="custom-select" id="dropdown_<?php echo e($attribute['id']); ?>" name="attributes[<?php echo e($attribute['id']); ?>]">
            <?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($value['value']); ?>"
                    ...
                    data-value-id="<?php echo e($value['id']); ?>"
                    data-modifier="<?php echo e($value['price_modifier_type'] ?? 'add'); ?>"
                    <?php echo e($value['is_default'] ? 'selected data-selected=true' : ''); ?>>
                    <?php echo e($value['value']); ?>
...
<?php endif; ?>
<?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/front/attribute-block.blade.php ENDPATH**/ ?>