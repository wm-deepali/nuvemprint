      ...
      <div class="col-md-12">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="slug_url" name="slug_url" value="<?php echo e($blog->slug); ?>"
              required>
            </div>
            ...
            <div class="form-group">
              ...
              value="<?php echo e($blog->meta_title); ?>" required>
            </div>

            <div class="form-group">
              <label for="meta_keywords">Meta Keywords</label>
              <input type="text" class="form-control" id="meta_keywords" name="meta_keywords"
              value="<?php echo e($blog->meta_keyword); ?>" required>
            </div>

            <div class="form-group">
              <label for="thumbnail">Thumbnail Image</label>
              <input type="file" class="form-control-file" id="thumbnail" name="thumbnail" accept="image/*">
              <img id="thumbnail-preview" src="<?php echo e(asset('storage/' . $blog->thumbnail)); ?>"
            ...
            <div class="form-group">
              ...
              <?php if($blog->banner): ?>
          <img id="banner-preview" src="<?php echo e(asset('storage/' . $blog->banner)); ?>" alt="Banner Preview"
        ...
        <?php endif; ?>
            ...
            <div class="form-group">
              ...
              required><?php echo e($blog->detail); ?></textarea>
            </div>

            <div class="form-group">
              <label for="meta_description">Meta Description</label>
              <textarea class="form-control" id="meta_description" name="meta_description" rows="4"
              required><?php echo e($blog->meta_description); ?></textarea>
            </div>
            </div>
          </div>
...
<?php $__env->startPush('scripts'); ?>
  ...
  <script>
    ...
    $('#blogForm').on('submit', function (e) {
      ...
      $.ajax({
      url: "<?php echo e(route('admin.content.blogs.update', $blog->id)); ?>",
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
