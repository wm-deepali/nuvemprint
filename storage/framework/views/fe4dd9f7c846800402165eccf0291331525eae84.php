          ...
          <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.pricing-rules.store')); ?>" id="pricing-rule-form">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-3">
                  <label for="centralized_cover_weight_rates">Apply Centralized Cover Paper Weight-Based Rates</label>
                  <select class="form-control" name="centralized_cover_weight_rates" id="centralized_cover_weight_rates"
                    required>
                    <option value="">-- Select --</option>
                    <option value="1">Yes</option>
                    <option value="0">No</option>
              ...
              <div class="form-row d-flex align-items-end" style="display: flex;">
                ...
                <div class="form-group col-md-2">
                  <label for="quantity_input_required">Default Quantity Input Required  </label>
                      <select name="quantity_input_required" id="quantity_input_required" class="form-control" required>
                        <option value="">-- Select --</option>
              ...
              <div id="quantity_fields" class="form-row">
                <div class="form-group col-md-2">
