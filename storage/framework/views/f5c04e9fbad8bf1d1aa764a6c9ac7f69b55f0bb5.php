    ...
    <div class="app-content content">
        <div class="content-wrapper">
            <div class="content-header row mb-2">
                <div class="col-md-6">
                    <h4 class="mb-0">Add Cover Paper Weight Rates</h4>
                    <small class="text-muted d-block mt-1">
                        <i class="fas fa-info-circle"></i> Pricing is based on the <strong>SRA3 sheet</strong>
                    </small>
                </div>
            ...
            $(document).ready(function () {
                ...
                function getDependencyRowHtml(index) {
                    ...
                    html += `
                            <div class="col-md-3">
                                <label>Price</label>
                                <input type="number" name="rows[${index}][price]" class="form-control price-input" step="0.01" min="0" placeholder="Price of SRA3 sheets" required data-index="${index}">
                                <small class="text-muted d-block">Enter price of SRA3 sheet</small>
                            </div>
                            </div>
                            <div>
                ...
                $('#paper-weight-form').submit(function (e) {
                    e.preventDefault();
                    $.ajax({
                        url: "<?php echo e(route('admin.cover-paper-weight-rates.store')); ?>",
                        method: "POST",
                        data: $(this).serialize(),
