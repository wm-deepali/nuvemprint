                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(route('admin.header-contact.index')); ?>">Header & Contact Info</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact_number" class="form-control" value="<?php echo e(old('contact_number', $contact->contact_number)); ?>">
                                    <div class="invalid-feedback" id="error-contact_number"></div>
                                    <div class="form-check mt-1">
                                        <input type="checkbox" name="show_on_header" value="1" class="form-check-input" id="show_on_header" <?php echo e($contact->show_on_header ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mobile_number" class="form-control" value="<?php echo e(old('mobile_number', $contact->mobile_number)); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="website_url" class="form-control" value="<?php echo e(old('website_url', $contact->website_url)); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="full_address" id="full_address" class="form-control" rows="3"><?php echo e(old('full_address', $contact->full_address)); ?></textarea>
