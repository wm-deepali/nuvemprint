...
<?php $__env->startSection('content'); ?>
	<style>
		...
		.page-content {
			...
			/* Adjust 100px based on header + footer height */
		}
	</style>
	<style>
	...
	<div class="page-wrapper">
		<div class="page-content">
			...
			<section class="">
				<div class="container">
					<div class="section-authentication-signin d-flex align-items-center justify-content-center py-5"
									...
									<div class="card-body" style="background:#ebebeb30;">
										<div class="border p-4 rounded">
											<div class="text-center">
												<h3 class="">Sign in</h3>
												<p>Don't have an account yet? <a href="<?php echo e(route('authentication-signup')); ?>"
														style="color:#ff4880; margin-left:6px;">Sign up here</a>
												</p>
											</div>
											<div class="d-grid">
												<a class="btn-login-page mb-4 mt-2  " style="background:#d9d9d9;"
											...
											<div class="form-body">
												<form id="loginForm" method="post"
													action="<?php echo e(route('customer.authenticate')); ?>"
													...
													<div class="col-md-6 text-end"> <a
															href="<?php echo e(route('authentication-forgot-password.get')); ?>"
															style="color:#ff4880; ">Forgot Password ?</a>
													</div>
													<div class="col-12">
														<div class="d-grid">
