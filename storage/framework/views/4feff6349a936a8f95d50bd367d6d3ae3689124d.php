      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <?php endif; ?>
            ...
            <p><strong>Notes:</strong> <span class="note-text"><?php echo e($department->pivot->notes ?? '-'); ?></span></p>

            <!-- Add Edit Button -->
            <button class="btn btn-sm btn-warning edit-note-btn" data-quote-id="<?php echo e($quote->id); ?>"
              data-department-id="<?php echo e($department->id); ?>" data-department-name="<?php echo e($department->name); ?>"
              data-notes="<?php echo e($department->pivot->notes); ?>">
              Edit
            </button>
...
</div><?php /**PATH D:\web-mingo-project\nuvem_prints\resources\views/admin/quotes/tabs/approved.blade.php ENDPATH**/ ?>