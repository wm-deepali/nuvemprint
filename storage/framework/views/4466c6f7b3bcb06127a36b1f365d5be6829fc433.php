				...
				<div class="container">
					<nav class="navbar navbar-expand">
						...
						<ul class="navbar-nav ms-auto d-none d-lg-flex">
							<li class="nav-item"> <a class="nav-link text-gray" href="<?php echo e(route('order-tracking')); ?>">Track Order</a>
							</li>
							<li class="nav-item"> <a class="nav-link text-gray" href="<?php echo e(route('shop-categories')); ?>">Instant Quote</a>
							</li>
							...
							<li class="nav-item"> <a class="nav-link text-gray" href="<?php echo e(route('contact-us')); ?>">Help & Support</a>
							</li>
						</ul>
						<ul class="navbar-nav">
							...
							<div class="d-flex align-items-center">
								...
								<div class="logo d-none d-lg-flex">
									<a href="<?php echo e(route('home')); ?>">
										<img src="<?php echo e(URL::asset('assets/images/NuvemPrint.png')); ?>" class="logo-icon" alt="" />
    ...
    <div class="dropdown-menu dropdown-large-menu custom-mega-menu">
        <div class="row">
            ...
            <div class="col-md-5 custom-subcat-list">
                <?php $__currentLoopData = $menucats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $menucat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="custom-subcat-content <?php echo e($index == 0 ? 'd-block' : 'd-none'); ?>" id="cat-<?php echo e($menucat->id); ?>">
            ...
            <div class="col-md-3">
                <div class="pramotion-banner1">
                    <img src="<?php echo e(URL::asset('assets/images/gallery/menu-img.jpg')); ?>" class="img-fluid"
                        alt="Printing Menu Banner" />
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/layouts/includes/header.blade.php ENDPATH**/ ?>