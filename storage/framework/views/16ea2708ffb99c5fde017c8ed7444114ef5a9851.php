      ...
      <div class="col-md-12">
        ...
        <div class="card-body">
          ...
          <tr>
            ...
            <td><?php echo e($cond->subcategory->name ?? '-'); ?></td>
            <td>
            If <strong><?php echo e($cond->parentAttribute->name ?? ''); ?></strong> =
        ...
        <?php endif; ?>
            ...
            <li class="list-inline-item">
            <a href="javascript:void(0)" onclick="deleteAttributeCondition(<?php echo e($cond->id); ?>)">
...
<?php $__env->startPush('scripts'); ?>
  <script>
    ...
    $('#add-attribute-condition').click(function () {
      $.get("<?php echo e(route('admin.attribute-conditions.create')); ?>", function (result) {
      if (result.success) {
    ...
    $(document).on('click', '.edit-attribute-condition', function () {
      ...
      $.get(`<?php echo e(url('admin/attribute-conditions')); ?>/${id}/edit`, function (result) {
      if (result.success) {
        $('#attribute-condition-modal').html(result.html).modal('show');
      }
      });
    ...
    $.ajax({
      url: "<?php echo e(route('admin.attribute-conditions.store')); ?>",
      method: 'POST',
      data: formData,
      processData: false,
      contentType: false,
  ...
  $.ajax({
    ...
    Swal.fire({
      ...
      $.ajax({
        url: `<?php echo e(url('admin/attribute-conditions')); ?>/${id}`,
        type: 'POST',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/admin/attribute-conditions/index.blade.php ENDPATH**/ ?>