                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr id="assignment-row-<?php echo e($item->id); ?>">
                                                ...
                                                <td>
                                                    <span
                                                        class="badge badge-<?php echo e($item->is_toggleable ? 'success' : 'secondary'); ?>">
                                                        <?php echo e($item->is_toggleable ? 'Yes' : 'No'); ?>
                                                ...
                                                <td>
                                                    <ul class="list-inline mb-0">
                                                        ...
                                                        <li class="list-inline-item">
                                                            <a href="javascript:void(0)"
                                                                onclick="deleteConfirmation(<?php echo e($item->id); ?>)">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#add-group-assignments', function () {
                $.get("<?php echo e(route('admin.group-assignments.create')); ?>", function (result) {
                    if (result.success) {
            ...
            $(document).on('click', '.edit-group-assignment', function () {
                ...
                $.get(`<?php echo e(url('admin/group-assignments')); ?>/${id}/edit`, function (result) {
                    if (result.success) {
                        $('#group-assignment-modal').html(result.html).modal('show');
                    }
                });
            ...
            $(document).on('click', '#save-group-btn', function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.group-assignments.store')); ?>", // Update this route if needed
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/admin/group-assignments/index.blade.php ENDPATH**/ ?>