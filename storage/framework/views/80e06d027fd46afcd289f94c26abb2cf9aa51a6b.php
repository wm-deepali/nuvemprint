                            ...
                            <div class="bg-white p-4 shadow-sm">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <div>
                                        ...
                                        <small class="text-muted">#<?php echo e($invoice->invoice_number ?? 'N/A'); ?></small>
                                    </div>
                                ...
                                <div class="d-flex   overflow-hidden mb-4"
                                    ...
                                    <div class="col-4 p-3 border-right">
                                        ...
                                        <p class="mb-1"><strong>Order ID:</strong> #<?php echo e($quote->order_number); ?></p>
                                        <p class="mb-1"><strong>Payment Status:</strong>
                                            <?php echo e($payments->sum('amount_received') >= $quote->grand_total ? 'Paid' : 'Unpaid'); ?>

                                        </p>
                                        <p class="mb-1"><strong>Method:</strong>
                                            <?php echo e($payments->last()->payment_method ?? 'N/A'); ?></p>
                                        <p class="mb-0"><strong>Payment Date:</strong>
                                            <?php echo e(\Carbon\Carbon::parse($payments->last()->payment_date)->format('d M, Y') ?? 'N/A'); ?>
                                    ...
                                    <div class="col-4 p-3 border-right"
                                        ...
                                        <p class="mb-1"><?php echo e($quote->billingAddress->address); ?></p>
                                        <p class="mb-1"><?php echo e($customer->mobile ?? ''); ?></p>
                                        <p class="text-primary mb-0"><?php echo e($customer->email ?? ''); ?></p>
                                    </div>
                                    <div class="col-4 p-3">
                                        <strong>From</strong>
                                        <hr>
