  ...
  <div class="card rounded-0 custom-card">
    <div class="row g-0 align-items-stretch h-100">
      <div class="col-6 custom-image-box">
        <img src="<?php echo e(asset('storage/'.$indexsubcate->thumbnail)); ?>" class="custom-image" alt="" />
      </div>
      <div class="col-6 d-flex align-items-center">
        <div class="card-body">
          <h5 class="card-title text-uppercase" style="font-size:16px;"><?php echo e($indexsubcate->name); ?></h5>
          <p class="card-text text-uppercase">Starting at $9</p>
          <a href="<?php echo e(route('subcategory-details', ['slug' => $indexsubcate->slug])); ?>" class="btn btn-light btn-ecomm">Order Now</a>
        </div>
      </div>
    </div>
  </div>
							...
							<div class="latest-news owl-carousel owl-theme">
								<div class="item">
									<div class="card rounded-0 product-card border">
										...
										<a href="javascript:;">
											<img src="<?php echo e(URL::asset('assets/images/duplo.jpeg')); ?>"
												class="card-img-top border-bottom bg-dark-1" alt="..." height="200px">
										</a>
										<div class="card-body">
										...
										<div class="card-footer border-top">
											<a href="javascript:;">
												<p class="mb-0"><small class="text-gray">0 Comments</small>
												</p>
											</a>
										</div>
									</div>
								...
								<div class="item">
									<div class="card rounded-0 product-card border">
										...
										<a href="javascript:;">
											<img src="<?php echo e(URL::asset('assets/images/thesis.jpeg')); ?>"
												class="card-img-top border-bottom bg-dark-1" alt="..." height="200px">
										</a>
										<div class="card-body">
											<div class="news-title">
								...
								<div class="item">
									<div class="card rounded-0 product-card border">
										...
										<a href="javascript:;">
											<img src="<?php echo e(URL::asset('assets/images/banner.jpeg')); ?>"
												class="card-img-top border-bottom bg-dark-1" alt="..." height="200px">
										</a>
										<div class="card-body">
											<div class="news-title">
								...
								<div class="item">
									<div class="card rounded-0 product-card border">
										...
										<a href="javascript:;">
											<img src="<?php echo e(URL::asset('assets/images/blogs/04.png')); ?>"
												class="card-img-top border-bottom bg-dark-1" alt="..." height="200px">
										</a>
										<div class="card-body">
											<div class="news-title">
...
<?php echo $__env->make('layouts.new-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/front/index.blade.php ENDPATH**/ ?>