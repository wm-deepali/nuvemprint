<!--start footer section-->
						...
						<div class="col">
							<div class="footer-section2 mb-3">
								...
								<ul class="list-unstyled">
									...
									<li class="mb-1"><a href="<?php echo e(route('subcategory-details', ['slug' => $fsubcate->slug])); ?>"><i class='bx bx-chevron-right'></i><?php echo e($fsubcate->name); ?></a></li>
							...
							<div class="col-12 col-lg-6">
								<div class="image-zoom-section">
									<div class="product-gallery owl-carousel owl-theme border mb-3 p-3"
										data-slider-id="1">
										<div class="item">
											<img src="<?php echo e(URL::asset('assets/images/product-gallery/01.png')); ?>" class="img-fluid" alt="">
										</div>
										<div class="item">
											<img src="<?php echo e(URL::asset('assets/images/product-gallery/02.png')); ?>" class="img-fluid" alt="">
										</div>
										<div class="item">
											<img src="<?php echo e(URL::asset('assets/images/product-gallery/03.png')); ?>" class="img-fluid" alt="">
										</div>
										<div class="item">
											<img src="<?php echo e(URL::asset('assets/images/product-gallery/04.png')); ?>" class="img-fluid" alt="">
										</div>
									</div>
									<div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
										<button class="owl-thumb-item">
											<img src="<?php echo e(URL::asset('assets/images/product-gallery/01.png')); ?>" class="" alt="">
										</button>
										<button class="owl-thumb-item">
											<img src="<?php echo e(URL::asset('assets/images/product-gallery/02.png')); ?>" class="" alt="">
										</button>
										<button class="owl-thumb-item">
											<img src="<?php echo e(URL::asset('assets/images/product-gallery/03.png')); ?>" class="" alt="">
										</button>
										<button class="owl-thumb-item">
											<img src="<?php echo e(URL::asset('assets/images/product-gallery/04.png')); ?>" class="" alt="">
										</button>
									</div>
								</div>
							</div>
	...
	<!--end switcher--><?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/layouts/includes/footer.blade.php ENDPATH**/ ?>