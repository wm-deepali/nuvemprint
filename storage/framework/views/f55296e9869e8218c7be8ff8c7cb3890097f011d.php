          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-4">
              <div class="rounded shadow-sm overflow-hidden">
                <iframe src="<?php echo e($mapUrl); ?>" class="w-100" height="400" style="border:0;" allowfullscreen
                  loading="lazy"></iframe>
              </div>
              <!-- <div class="p-3 bg-light rounded ">-->
              <!--  <h5 class="mb-3">Contact Information</h5>-->
              <!--  <p><strong>Address:</strong><br><?php echo e($contactFooter->full_address ?? 'Unit 7 Lotherton Way Garforth Leeds LS252JY'); ?></p>-->
              <!--  <p><strong>Phone:</strong><br><?php echo e($contactFooter->contact_number ?? '01132 874724'); ?></p>-->
              <!--  <p><strong>Email:</strong><br><?php echo e($contactFooter->email ?? 'andy@nuvemprint.com'); ?></p>-->
            ...
            <div class="col-md-6 bg-light rounded ">
              <div class="mb-4 ">
                ...
                <p>
                  <strong>Address:</strong><br><?php echo e($contactFooter->full_address ?? 'Unit 7 Lotherton Way Garforth Leeds LS252JY'); ?>
              ...
              <form id="contact-form" method="POST" action="<?php echo e(route('contact.submit')); ?>">
                <?php echo csrf_field(); ?>
