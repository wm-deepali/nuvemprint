							...
							<div class="card mb-0">
								<div class="card-body">
									<div class="border p-4 rounded">
										...
										<div class="form-body">
											<form class="row g-3" id="registerForm" method="post" action="<?php echo e(route('first.details.store')); ?>" enctype="multipart/form-data">
											<?php echo csrf_field(); ?>
												<div class="col-sm-6">
													<label for="inputFirstName" class="form-label">Name</label>
													<input type="text" name="first_name" class="form-control" value="<?php echo e($user->name); ?>" id="inputFirstName" placeholder="Jhon" required>
												</div>
												
												<div class="col-12">
													<label for="inputEmailAddress" class="form-label">Email Address</label>
													<input type="email" name="email" class="form-control" value="<?php echo e($user->email); ?>" id="inputEmailAddress" placeholder="example@user.com" required>
													<span id="email_feedback" style="display:none; color:red;">Email already exists</span>
												</div>
												<div class="col-12">
												    <label for="inputMobile" class="form-label">Mobile</label>
                                                    <input type="tel" onkeypress="return isNumber(event)" autocomplete="off" class="form-control" name="mobile"  minlength="10" maxlength="10" placeholder="Moblie number" id="inputMobile" required>
                                                </div>
												<div class="col-12">
												...
												<div class="col-12">
													...
													<select class="form-select" name="country" id="inputSelectCountry" aria-label="Default select example" required>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.new-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/nuvem.tpmhelpinghand.com/resources/views/front/add-details.blade.php ENDPATH**/ ?>